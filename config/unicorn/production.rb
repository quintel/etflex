...
listen "#{app_directory}/shared/pids/unicorn.sock", backlog: 64

# File containing the Unicorn process ID.
pid "#{app_directory}/shared/pids/unicorn.pid"

# Set the path of the log files inside the log folder of the testapp
stderr_path "#{app_directory}/shared/log/unicorn.log"
stdout_path "#{app_directory}/shared/log/unicorn.log"

before_exec do |server|
  ENV['BUNDLE_GEMFILE'] = "#{app_directory}/current/Gemfile"
end
